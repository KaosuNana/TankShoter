...
public class UbhWavingNwayLockOnShot : UbhWavingNwayShot
{
	...
	{
		internal UbhWavingNwayLockOnShot _this;
	...
	[Header("===== WavingNwayLockOnShot Settings ====="), FormerlySerializedAs("_SetTargetFromTag")]
	...
	{
		UbhWavingNwayLockOnShot._AimingCoroutine_c__Iterator0 _AimingCoroutine_c__Iterator = new UbhWavingNwayLockOnShot._AimingCoroutine_c__Iterator0();
