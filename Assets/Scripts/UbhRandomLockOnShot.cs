...
public class UbhRandomLockOnShot : UbhRandomShot
{
	...
	{
		internal UbhRandomLockOnShot _this;
	...
	[Header("===== RandomLockOnShot Settings ====="), FormerlySerializedAs("_SetTargetFromTag")]
	...
	{
		UbhRandomLockOnShot._AimingCoroutine_c__Iterator0 _AimingCoroutine_c__Iterator = new UbhRandomLockOnShot._AimingCoroutine_c__Iterator0();
