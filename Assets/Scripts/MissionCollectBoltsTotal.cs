...
public class MissionCollectBoltsTotal : Mission
{
	...
	public override void LoadMissionProgress()
	{
		...
		{
			ES2.Load<MissionCollectBoltsTotal>(this.savedFileName, this);
		}
		else
		{
			base.fileVersion = 1f;
	...
	{
		EventManager.StartListening("CollectBolts", new UnityAction(this.AddAmount));
	}

	private void SaveMissionProgress()
	{
		ES2.Save<MissionCollectBoltsTotal>(this, this.savedFileName);
	}

	public override void StopListening()
	{
		EventManager.StopListening("CollectBolts", new UnityAction(this.AddAmount));
	}
