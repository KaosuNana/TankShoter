...
public class ES2Init : MonoBehaviour
{
	...
	public static void Init()
	{
		...
		ES2TypeManager.types[typeof(MissionCollectBoltsTotal)] = new ES2UserType_MissionCollectBoltsTotal();
		ES2TypeManager.types[typeof(MissionCollectCoinMagnetPowerUp)] = new ES2UserType_MissionCollectCoinMagnetPowerUp();
		ES2TypeManager.types[typeof(MissionCollectPowerUp)] = new ES2UserType_MissionCollectPowerUp();
		ES2TypeManager.types[typeof(MissionContinue)] = new ES2UserType_MissionContinue();
		ES2TypeManager.types[typeof(MissionShootBossTotal)] = new ES2UserType_MissionShootBossTotal();
		ES2TypeManager.types[typeof(MissionShootMiniBossTotal)] = new ES2UserType_MissionShootMiniBossTotal();
		ES2TypeManager.types[typeof(MissionShootTotal)] = new ES2UserType_MissionShootTotal();
		ES2TypeManager.types[typeof(MissionShootUsingEnemyBomb)] = new ES2UserType_MissionShootUsingEnemyBomb();
		ES2TypeManager.types[typeof(PowerUpInfo)] = new ES2UserType_PowerUpInfo();
		ES2TypeManager.types[typeof(VehicleInfo)] = new ES2UserType_VehicleInfo();
		ES2TypeManager.types[typeof(AudioClip)] = new ES2_AudioClip();
		ES2TypeManager.types[typeof(MissionWaveCleared)] = new ES2UserType_MissionWaveCleared();
