	...
	private sealed class _ShotCoroutine_c__Iterator0 : IEnumerator, IDisposable, IEnumerator<object>
	{
		...
		public bool MoveNext()
		{
			...
			//	IL_102:
				...
				this._centerAngle___2 = this._this.m_waveCenterAngle + this._this.m_waveRangeSize / 2f * Mathf.Sin(UbhSingletonMonoBehavior<UbhTimer>.instance.frameCount * this._this.m_waveSpeed / 100f);
...
//				goto IL_102;
	...
	[Header("===== WavingNwayShot Settings ====="), FormerlySerializedAs("_WayNum")]
