...
public class MissionShootMiniBossTotal : Mission
{
	private void Start()
	{
	...
	public override void LoadMissionProgress()
	{
		...
		{
			ES2.Load<MissionShootMiniBossTotal>(this.savedFileName, this);
		}
		else
		{
			base.fileVersion = 1f;
	...
	{
		EventManager.StartListening("ShootMiniBoss", new UnityAction(this.AddAmount));
	}

	private void SaveMissionProgress()
	{
		ES2.Save<MissionShootMiniBossTotal>(this, this.savedFileName);
	}

	public override void StopListening()
	{
		EventManager.StopListening("ShootMiniBoss", new UnityAction(this.AddAmount));
	}
