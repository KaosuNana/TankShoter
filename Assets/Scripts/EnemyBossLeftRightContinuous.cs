...
public class EnemyBossLeftRightContinuous : EnemyBoss
{
	...
	protected override void ExtraFunctionOnEnable()
	{
		...
		}).Append(base.transform.DOMoveX(-5f, 1f, false).SetEase(Ease.Linear)).Append(base.transform.DOMoveX(5f, 2f, false).SetEase(Ease.Linear)).Append(base.transform.DOMoveX(-5f, 2f, false).SetEase(Ease.Linear)).Append(base.transform.DOMoveX(5f, 2f, false).SetEase(Ease.Linear)).AppendCallback(delegate
		{
