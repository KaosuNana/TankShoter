...
public class MissionShootUsingEnemyBomb : Mission
{
	private void Start()
	{
	...
	public override void LoadMissionProgress()
	{
		...
		{
			ES2.Load<MissionShootUsingEnemyBomb>(this.savedFileName, this);
		}
		else
		{
			base.fileVersion = 1f;
	...
	{
		EventManager.StartListening("EnemyBomb", new UnityAction(this.AddAmount));
	}

	private void SaveMissionProgress()
	{
		ES2.Save<MissionShootUsingEnemyBomb>(this, this.savedFileName);
	}

	public override void StopListening()
	{
		EventManager.StopListening("EnemyBomb", new UnityAction(this.AddAmount));
	}
