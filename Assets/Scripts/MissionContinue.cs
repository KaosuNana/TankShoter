...
public class MissionContinue : Mission
{
	private void Start()
	{
	...
	public override void LoadMissionProgress()
	{
		...
		{
			ES2.Load<MissionContinue>(this.savedFileName, this);
		}
		else
		{
			base.fileVersion = 1f;
	...
	{
		EventManager.StartListening("ContinueTotal", new UnityAction(this.AddAmount));
	}

	private void SaveMissionProgress()
	{
		ES2.Save<MissionContinue>(this, this.savedFileName);
	}

	public override void StopListening()
	{
		EventManager.StopListening("ContinueTotal", new UnityAction(this.AddAmount));
	}
