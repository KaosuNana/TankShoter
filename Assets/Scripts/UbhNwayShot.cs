...
public class UbhNwayShot : UbhBaseShot
{
	...
	[Header("===== NwayShot Settings ====="), FormerlySerializedAs("_WayNum")]
	...
	{
		UbhNwayShot._ShotCoroutine_c__Iterator0 _ShotCoroutine_c__Iterator = new UbhNwayShot._ShotCoroutine_c__Iterator0();
